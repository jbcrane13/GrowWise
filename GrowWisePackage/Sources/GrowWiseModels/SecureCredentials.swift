...
public enum SecureTokenEncryption {
    // MARK: - Error Types
    ...
    public static func createSecureStorage(
        ...
        do {
            let sealedBox: AES.GCM.SealedBox = if let aad = additionalAuthenticatedData {
    ...
    public static func retrieveFromSecureStorage(
        ...
        do {
            ...
            let decryptedData: Data = if let aad {
                try AES.GCM.open(sealedBox, using: key, authenticating: aad)
            } else {
