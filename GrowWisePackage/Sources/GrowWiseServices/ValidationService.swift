...
public final class ValidationService: Sendable {
    ...
    public func validateHeight(_ text: String) -> ValidationResult {
        validateNumber(text, fieldName: "Height", min: 0, max: 10000, allowDecimals: true)
    }

    public func validateWidth(_ text: String) -> ValidationResult {
        validateNumber(text, fieldName: "Width", min: 0, max: 10000, allowDecimals: true)
    }

    public func validateTemperature(_ text: String) -> ValidationResult {
        validateNumber(text, fieldName: "Temperature", min: -50, max: 150, allowDecimals: true)
    }

    public func validateHumidity(_ text: String) -> ValidationResult {
        validateNumber(text, fieldName: "Humidity", min: 0, max: 100, allowDecimals: true)
    }

    public func validateWaterAmount(_ text: String) -> ValidationResult {
        validateNumber(text, fieldName: "Water amount", min: 0, max: 10000, allowDecimals: true)
    }
