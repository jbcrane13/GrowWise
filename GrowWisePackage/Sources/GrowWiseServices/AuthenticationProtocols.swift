...
public struct FallbackKeychainStorage: KeychainStorageProtocol {
    public enum FallbackError: LocalizedError {
        case notInitialized
        public var errorDescription: String? { "KeychainStorage not initialized properly" }
    }
    
    public init() {}
    public func store(_ data: Data, for key: String) throws { throw FallbackError.notInitialized }
    public func storeString(_ string: String, for key: String) throws { throw FallbackError.notInitialized }
    public func retrieve(for key: String) throws -> Data { throw FallbackError.notInitialized }
    public func retrieveString(for key: String) throws -> String { throw FallbackError.notInitialized }
    public func delete(for key: String) throws { throw FallbackError.notInitialized }
    public func deleteAll() throws { throw FallbackError.notInitialized }
    public func exists(for key: String) -> Bool { return false }
}
...
public struct FallbackBiometricAuthentication: BiometricAuthenticationProtocol {
    public enum FallbackError: LocalizedError {
        case notInitialized
        public var errorDescription: String? { "BiometricAuthentication not initialized properly" }
    }
    ...
    public func authenticateWithBiometrics(reason: String?) async throws { throw FallbackError.notInitialized }
    public func checkAuthenticationStatus(timeoutMinutes: Int) -> Bool { return false }
}
