# PRD: test: PlantDatabaseService integration tests — validate seeded plant data fields, not just count

## Issue
#373 in jbcrane13/growwise
## Tasks
- [x] Implement test: PlantDatabaseService integration tests — validate seeded plant data fields, not just count
